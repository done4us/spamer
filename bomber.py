...
def bann_text():
    clr()
    logo = """
.d8888. d8888b.  .d8b.  .88b  d88. d88888b d8888b.
88'  YP 88  `8D d8' `8b 88'YbdP`88 88'     88  `8D
`8bo.   88oodD' 88ooo88 88  88  88 88ooooo 88oobY'
  `Y8b. 88~~~   88~~~88 88  88  88 88~~~~~ 88`8b
db   8D 88      88   88 88  88  88 88.     88 `88.
`8888Y' 88      YP   YP YP  YP  YP Y88888P 88   YD """
...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("spamer was updated to the latest version")
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/done4us/spamer/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("spamer is up-to-date")
        mesgdcrt.GeneralMessage("Starting spamer")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("spamer was created by Done4us")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("Spamer will work only in Python v3")
    sys.exit()
...
description = """Spamer - Your Friendly Spammer Application

Spamer can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

Spamer is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Done4us !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start Spamer with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start Spamer with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start Spamer with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update Spamer")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current Spamer contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current Spamer version")
